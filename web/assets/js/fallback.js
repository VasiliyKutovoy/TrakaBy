...
(function () {
  ...
  $modal = function (options) {
    ...
    function _createModal(options) {
      ...
      modalHTML = modalTemplate.replace('{{title}}', options.title || 'Наши контакты:');
      modalHTML = modalHTML.replace('{{content}}', options.content || '+375255098422 (Viber,Telegram),    +375293455183,     Bytrapka@gmail.com');
